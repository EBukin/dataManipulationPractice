...
*  `.CT-token` text file with the token for accessing to the Comtrade data (for more information [see](00-comtrade.html)).
...
1.  update `.CT-token` file inserting one line of your CT token without quot marks;
